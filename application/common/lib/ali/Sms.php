...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAItJyEv02IpC44"; // AccessKeyId

        $accessKeySecret = "RR1qDtLXdlF3UCxwild0Fyu4KmO2vI"; // AccessKeySecret
    ...
    public static function sendSms($phoneNum,$code) {
        ...
        $request->setSignName("tyrobot直播平台");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_139145027");
